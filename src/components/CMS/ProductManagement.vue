...
import AddProductsManagement from './AddProductsManagement.vue'
...
<template>
  <section class="product-management">
    ...
    <AddProductsManagement
      v-if="managementMode === 'add'"
    />

    <EditProductsManagement
      v-else
    />
  </section>
</template>
